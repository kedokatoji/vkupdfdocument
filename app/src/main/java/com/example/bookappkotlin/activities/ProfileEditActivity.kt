...
class ProfileEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //handle click, pick image from camera/glaery
    ...
    private fun updateProfile(uploadedImageUrl: String) {
        ...
        val hashMap = HashMap<String, Any>() //khong giong
        hashMap["name"] = "$name"
        if (imageUri != null){
...
//        Show popup menu with option Camera and Gallery
    ...
    //used to handle result of camera intent (new way in replacement of startactivityforreult)
    ...
    //used to handle result of gallery intent (new way in replacement of startactivityforreult)
