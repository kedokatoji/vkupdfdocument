...
class AdapterComment : RecyclerView.Adapter<AdapterComment.HolderComment>{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderComment {
        //bind/inflate layout row_comment.xml
    ...
    override fun onBindViewHolder(holder: HolderComment, position: Int) {
        ...
        //don't have user name, profile picture, but have user udi, will load using that uid
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    try {
                        ...
                        //in case of crash due to image to is empty or null or other reason, set default image
    ...
    override fun getItemCount(): Int {
        return commentArrayList.size //return list size | number of item in list
    }
